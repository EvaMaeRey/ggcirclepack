...
# ggcirclepack and beyond: experiments in the compute_panel space
...
### - And what ggplot2 actually renders, it computes for you (x and y)
...
### in a {ggpackcircles}, the answer 'where/which' of the circle isn't defined by the center, x0y0, but by its *id* and *area* (an algorithm used under the hood to find x0y0 and x and y for perimeter); 

--

### and the id and areas of all of the other circles to be drawn

--

### the *exactly where* (x and y perimeter) gets computed in the background by packing algorithm and ggplot2
...
### make a map with geom_polygon tutorial:  https://remiller1450.github.io/s230s19/Intro_maps.html
